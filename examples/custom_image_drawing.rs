...
impl AppDelegate for BasicApp {
    fn did_finish_launching(&self) {
        ...
        LayoutConstraint::activate(&[
            self.image_view
                .top
                .constraint_equal_to(&self.content_view.top),
            self.image_view
                .leading
                .constraint_equal_to(&self.content_view.leading),
            self.image_view
                .trailing
                .constraint_equal_to(&self.content_view.trailing),
            self.image_view
                .bottom
                .constraint_equal_to(&self.content_view.bottom),
        ]);
