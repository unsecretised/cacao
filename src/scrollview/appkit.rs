...
extern "C" fn dragging_entered<T: ScrollViewDelegate>(
    this: &mut Object,
    _: Sel,
    info: id,
) -> NSUInteger {
...
/// Called when a drag/drop operation has entered this view.
extern "C" fn prepare_for_drag_operation<T: ScrollViewDelegate>(
    this: &mut Object,
    _: Sel,
    info: id,
) -> Bool {
...
/// Called when a drag/drop operation has entered this view.
extern "C" fn perform_drag_operation<T: ScrollViewDelegate>(
    this: &mut Object,
    _: Sel,
    info: id,
) -> Bool {
...
pub(crate) fn register_scrollview_class() -> &'static Class {
    load_or_register_class("NSScrollView", "RSTScrollView", |_decl| {})
}
